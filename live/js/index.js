...
function websdkready() {
  ...
  document
    ...
    .addEventListener("click", async function (e) {
      ...
      // "http://managethenow.co:3001/post",
      const response = await fetch(
        "https://zoom-signature-generator.onrender.com/post",
        {
          method: "POST",
          headers: {
      ...
      var joinUrl =
        "/mtn-live/live/meeting.php?" + testTool.serialize(meetingConfig);
