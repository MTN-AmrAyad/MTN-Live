...
<!-- MAIN -->
          <div class="w-100 d-flex flex-column  p-md-4 justify-content-lg-center" id="main-container" style="height: 650px; overflow: hidden;
...
// });
    ...
    <script src="view/js/autoSwitch_fullVersionPage(1).js"></script>
