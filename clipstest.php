...
echo '   <div class="option"  >
        <div class="ul_div"><ul class="contents 2">
...
echo '   <div class="option"  >
        <div class="ul_div"><ul class="contents 3">
...
echo '   <div class="option"  >
        <div class="ul_div"><ul class="contents 4">
...
<script>
  ...
  if (color === 'day11' || color === 'day12' || color === 'day13' || color === 'day14') {
    var startDay = (color === 'day11') ? 1 : (color === 'day12') ? 9 : (color === 'day13') ? 17 : 24;
    var endDay = startDay + 8;
    var dayCounter = 1;
    ...
    <script src="view/js/autoSwitch.js"></script>
<?php
