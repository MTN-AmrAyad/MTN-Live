...
<body style="background-image:url('https://managethenow.net/livesystem/2.png');background-repeat: repeat round;">
    ...
    justify-content: center;">
			    	<!--<img src='images/2.png' style="width:50%;height:170px">-->
			    	 		<img  style="width:200px ;height:150px"src='https://managethenow.net/mtn-live/view/imgs/logos/EBT-1.png' >
			    	</div>
					
				
		<h3 class="text-black mb-4 text-center" >EBT1<br>محو الأمية الشعورية </h3><br>
