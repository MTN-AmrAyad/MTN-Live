...
if(!$_SESSION){
    header("location : https://managethenow.net/mtn-live/checkout");
    exit();
    
}else{
    
    // Adam And Eve Handle with course code 600 = 8
      ...
      if($coursecode==600){
          $coursecode=8;
          $sql = "SELECT * FROM userData WHERE email=$email AND phone=$phone";
