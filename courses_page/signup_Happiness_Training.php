...
<html lang="en">
<head>
	<title>Happiness Training</title>
	<meta charset="UTF-8">
...
<body style='overflow-x: hidden;'>
    ...
    <div class="d-flex justify-content-center">
     		...
     		<img  style="width:250px ;height:150px"src='https://managethenow.net/mtn-live/view/imgs/logos/happy_trining.png' >
    </div>
					
				<h3 class="text-black mb-4 text-center" >تدريبات السعادة </h3>
