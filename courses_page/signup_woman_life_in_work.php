...
<body style='overflow-x: hidden;'>
    ...
    justify-content: center;'>
				        		 		...
				        		 		<img  style="width:250px ;height:150px"src='https://managethenow.net/mtn-live/view/imgs/logos/woman-live.png' >
				    </div>
		
					
				<h3 class="text-black mb-4 text-center" >حياة الأنثى في العمل
 </h3>
