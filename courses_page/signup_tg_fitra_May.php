...
<html lang="en">
<head>
	<title> Therapy GYM Fitra Jun </title>
	<meta charset="UTF-8">
...
<body style='overflow-x: hidden;'>
    ...
    <div class="d-flex justify-content-center">
     		...
     		<img  style="width:200px ;height:150px"src='https://managethenow.net/mtn-live/view/imgs/logos/Therapy-Gym-Al-Fitra-1.svg' >
    </div>
					
				<h3 class="text-black mb-4 text-center" >Therapy GYM Fitra </h3>
