...
<html lang="en">
<head>
	<title> CTRL Medicine-Anatomical </title>
	<meta charset="UTF-8">
...
<body style="background-image:url('https://managethenow.net/livesystem/270X133 ctrl تماهي.png');background-repeat: repeat round;">
	<div class="limiter">
    ...
    justify-content: center;'>
				        		<!--<img src='adamandeve.png' >-->
				        		 		<img  style="width:250px ;height:150px"src='https://managethenow.net/mtn-live/view/imgs/logos/CTRL-Medicine-Anatomical-Part.png' >
				    </div>
		
					
				<h3 class="text-black mb-4 text-center" > CTRL Medicine – Anatomical Part
