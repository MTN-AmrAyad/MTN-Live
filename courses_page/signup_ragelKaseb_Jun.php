			...
			<div class="wrap-login100" style='top: 2%;'>
              ...
              ?>
				...
				<div class="d-flex justify-content-center">
				 		...
				 		<img  style="width:200px ;height:130px"src='https://managethenow.net/mtn-live/view/imgs/logos/Therapy-Gym-Masculinity.png' >
				</div>
					
				<h3 class="text-black mb-4 text-center" >Masculinity GYM July
				<br>
