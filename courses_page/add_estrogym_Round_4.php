...
<div class="limiter">
    ...
    margin-top: 35px;'>
			    				...
			    				<img  style="height:120px;width:200px" src='https://managethenow.net/mtn-live/view/imgs/logos/Estrogym.png' >
     	...
     	<?php } ?>
					...
					<!--<option value=''>choose your course</option>-->
                          ...
                          <option value='7'>EBT 2 التشخيص والعلاج</option>-->
                           ...
                           <option value='30'> EstroGYM - Round 4 </option>
