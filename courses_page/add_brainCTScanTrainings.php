...
<html>
   <head>
	<title> Add Brain CT Scan TRAINING  </title>
	<meta charset="UTF-8">
...
<div class="limiter">
    ...
    margin-top: 35px;'>
			    				...
			    				<!--<img  src='Brain CT SCAN Training.png' style="width:150px;height:150px">-->

			    				<img  style="height:120px;width:170px" src='https://managethenow.net/mtn-live/view/imgs/logos/Brain-CT-Scan.png' >
     	...
     	<?php } ?>
					...
					<!--<option value=''>choose your course</option>-->
                          ...
                          <option value='7'>EBT 2 التشخيص والعلاج</option>
                           ...
                           <option value='8'> Adam & Eve - Main Level    </option>
