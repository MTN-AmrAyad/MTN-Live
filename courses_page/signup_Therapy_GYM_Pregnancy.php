...
<html lang="en">
<head>
	<title> Therapy GYM Pregnancy </title>
	<meta charset="UTF-8">
...
<body style='overflow-x: hidden;'>
    ...
    justify-content: center;'>
				        		<img  style="width:200px ;height:150px"src='https://managethenow.net/mtn-live/view/imgs/logos/The-Pleasant-Journey.png' >
				    </div>
		
					
				<h3 class="text-black mb-4 text-center" >Therapy GYM Pregnancy
 </h3>
