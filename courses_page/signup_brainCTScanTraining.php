...
<body style='overflow-x: hidden;'>
	...
	<div class="limiter">
		<div class="container-login100">
		       ...
		       <img  src="st scan.png" style='opacity: 0.3; '>
    ...
    justify-content: center;'>
				        		<!--<img src='Brain CT SCAN Training.png' style='height:170px' >-->
				        		 		<img  style="width:200px ;height:150px"src='https://managethenow.net/mtn-live/view/imgs/logos/Brain-CT-Scan.png' >
				    </div>
		
					
				<h3 class="text-black mb-4 text-center" >Brain CT Scan TRAININGS</h3>
