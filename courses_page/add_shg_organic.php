...
<div class="limiter">
    ...
    margin-top: 35px;'>
			    				...
			    				<img  style="height:160px;width:160px" src='https://managethenow.net/mtn-live/view/imgs/logos/Self-healingGuide-Organic.png' >
...
مرشد الشفاء الذاتي - الجزء العضوي 
<br>
     	...
     	<?php } ?>
					...
					<!--<option value=''>choose your course</option>-->
                         ...
                         <!--   <option value='9'> Adam & Eve - Adv. Level   </option>
                           ...
                           <option value='22'>Self healing Guide Organic</option>-->
                        </select>
