...
<html lang="en">
<head>
	<title> اCTRL Medicine – Psychologic Part  </title>
	<meta charset="UTF-8">
...
<body style='overflow-x: hidden;'>
    ...
    justify-content: center;'>
				        		<img  style="width:250px ;height:150px" src='https://managethenow.net/mtn-live/view/imgs/logos/CTRL-Medicine.png' >
				        		<br>
				    </div>
		
					
				<h3 class="text-black mb-4 text-center" >CTRL Medicine – Psychologic Part   
 </h3>
