...
<html lang="en">
<head>
	<title> التواصل بين الذكر والأنثى </title>
	<meta charset="UTF-8">
...
<body style='overflow-x: hidden;'>
    ...
    justify-content: center;'>
				        		<img  style="width:200px ;height:130px" src='https://managethenow.net/mtn-live/view/imgs/logos/Communication-2.png' >
				        		<!--<br>-->
				    </div>
		
					
				<h3 class="text-black mb-4 text-center" >التواصل بين الذكر والأنثى
 </h3>
