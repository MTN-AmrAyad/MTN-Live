	...
	<div class="limiter">
		<div class="container-login100">
			...
			<div class="wrap-login100" style='top: 2%;'>
              ...
              ?>
				<form class="login100-form validate-form" autocomplete="off" action="shg_controller.php" method="GET" style="padding-top:15px" >
				    
				    <div style='display: flex;
    justify-content: center;'>
				        		<img  style="width:160px ;height:160px;margin-bottom:20px" src='https://managethenow.net/mtn-live/view/imgs/logos/logo-SHG.png' >
				        		<br>
				    </div>
	

					<span class="login100-form-title p-b-34 " style="font-size:18px">
							October 2023
					</span>
...
<div id="example" 
  ...
  <option value="zimbabwean">Zimbabwean</option>
					...
					<div class="container-login100-form-btn">
						<input type="submit" value="Save" class="btn btn_submit" name="submit" />
					</div>
