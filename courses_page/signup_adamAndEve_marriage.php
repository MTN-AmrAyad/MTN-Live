...
<body style='overflow-x: hidden;'>
    ...
    justify-content: center;'>
				        		<img  style="width:150px ;height:150px"src='https://managethenow.net/mtn-live/view/imgs/logos/Adam_Eve_Marriage.png' >
				        		<!--<br>-->
				    </div>
		
					
				<h3 class="text-black mb-4 text-center" >آدم وحواء – الزواج
 </h3>
