...
<html lang="en">
<head>
	<title>Therapy GYM الأنوثة - مسجل  </title>
	<meta charset="UTF-8">
...
<body style='overflow-x: hidden;'>
    ...
    justify-content: center;'>
				        		<img  style="width:200px ;height:150px" src='https://managethenow.net/mtn-live/view/imgs/logos/womane_recorded.png' >
				        		<br>
				    </div>
		
					
				<h3 class="text-black mb-4 text-center" >Therapy GYM الأنوثة - مسجل
 </h3>
