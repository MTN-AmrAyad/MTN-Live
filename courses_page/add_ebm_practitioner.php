...
<div class="limiter">
    ...
    margin-top: 35px;'>
			    				...
			    				<img  style="height:120px;width:200px" src='https://managethenow.net/mtn-live/view/imgs/logos/EBM.png' >
    ...
    width: 100%;' class="login100-form-title p-b-34 ">
				EBM  <span style='font-size:15px'> Practitioner </span> 
