...
<body style='overflow-x: hidden;'>
    ...
    justify-content: center;'>
				        		<img  style="width:200px ;height:150px" src='https://managethenow.net/mtn-live/view/imgs/logos/Brain-CT-Scan.png' >
				        		<br>
				    </div>
		
					
				<h3 class="text-black mb-4 text-center" >Brain CT Scan  
 </h3>
