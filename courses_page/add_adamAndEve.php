...
<div class="limiter">
    ...
    margin-top: 35px;'>
			    				...
			    				<img  style="height:120px;width:200px" src='https://managethenow.net/mtn-live/view/imgs/logos/Adam&Eve.png' >
    ...
    width: 100%;' class="login100-form-title p-b-34 ">
					أدم وحواء -  <span style='font-size:15px'> المستوى الأساسي </span> 
