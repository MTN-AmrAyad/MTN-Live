...
<body style='overflow-x: hidden;'>
    ...
    <div class="d-flex justify-content-center">
     		...
     		<img  style="width:200px ;height:150px"src='https://managethenow.net/mtn-live/view/imgs/logos/mtn live AI.png' >
    </div>
					
				<h3 class="text-black mb-4 text-center" >Emotional Balance Technique Adv. Level </h3>
