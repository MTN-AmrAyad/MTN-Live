...
<html lang="en">
<head>
	<title> 	Therapy GYM Values special edition
 </title>
	<meta charset="UTF-8">
		...
		<div class="container-login100">
			...
			<div class="wrap-login100" style='top: 2%;'>
              ...
              ?>
				...
				<!--<img src='tgvalues.png' style="width: 100px;height:100px ;margin-left:140px;margin-top:50px">-->
				<div class="d-flex justify-content-center">
				    
				
				 		<img  style="width:200px ;height:150px"src='https://managethenow.net/mtn-live/view/imgs/logos/Therapy-Gym-Values.png' >
				</div>
					
				<h3 class="text-black mb-4 text-center" >Therapy GYM Values 
				<br>
				(Special Edition)
				</h3>
