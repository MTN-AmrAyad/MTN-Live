...
<html lang="en">
<head>
	<title>  الراجل الكسيب – تدريب شامل نوفمبر 2022 </title>
	<meta charset="UTF-8">
...
<body style='overflow-x: hidden;'>
    ...
    justify-content: center;'>
				        		<img  style="width:200px ;height:150px" src='https://managethenow.net/mtn-live/view/imgs/logos/Therapy-Gym-Masculinity.png' >
				        		<br>
				    </div>
		
					
				<h3 class="text-black mb-4 text-center" >الراجل الكسيب – تدريب شامل 
				<br>
				نوفمبر 2022
 </h3>
