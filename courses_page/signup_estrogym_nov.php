...
<body style="background-image:url('https://managethenow.net/livesystem/estro_space.png');">
	...
	<div class="limiter">
		<div class="container-login100">
			...
			<div class="d-flex justify-content-center">
					 		...
					 		<img  style="width:200px ;height:105px;margin:15px 0"src='https://managethenow.net/mtn-live/view/imgs/logos/Estrogym.png' >
			</div>
					...
					<h3 class="text-black mb-2 text-center" >
					    EstroGYM  - Nov
					 </h3>
					 <h3 class="text-black mb-4 text-center" >
					    					    تدريبات الأنوثة - نوفمبر
