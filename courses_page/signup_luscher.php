...
<body style="background-image:url('https://managethenow.net/livesystem/Untitled-1 (2).png');background-repeat: repeat round;">
		...
		<div class="container-login100">
			...
			<div class="wrap-login100" style='top: 2%;'>
              ...
              ?>
				...
				<img src='https://managethenow.net/mtn-live/view/imgs/logos/luscher_logo.png' style="width:100%;height:250px">
     ...
     data-onchangecallback="onChangeCallback">
    		 ...
    		 <div class="row">
    				...
    				<div class="wrap-input100 validate-input" style="display: flex;align-items: center;" data-validate = "Enter WhatApp Number">
    						<input class="input100 phone-field"  type="text"  id="phoneField" name="phonenumber" placeholder="Phone Number" autocomplete="off" id='phone' pattern="[0-9]+" maxlength="12" minlength="6" title="Incorrect Phone"  required title="Full Number Code Must Be Number">
    						<span class="focus-input100" data-placeholder=""></span>
