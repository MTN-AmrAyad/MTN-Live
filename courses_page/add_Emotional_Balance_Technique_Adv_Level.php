...
<div class="limiter">
    ...
    margin-top: 35px;'>
			    				...
			    				<!--<img  src='2.png' style="width:150px;height:150px">-->
			    					<img  style="width:200px ;height:150px"src='https://managethenow.net/mtn-live/view/imgs/logos/advanced-logo-final.png' >
...
<?php if (isset($_GET['error'])) { ?>
     	...
     	<?php } ?>
					...
					<!--<option value=''>choose your course</option>-->
                           ...
                           <option value='15'>Emotional Balance Technique Adv Level</option>
