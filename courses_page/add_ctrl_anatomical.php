...
<div class="limiter">
    ...
    margin-top: 35px;'>
			    				...
			    				<!--<img  src="270X133 ctrl تماهي.png">-->
			    				
			    				<img  style="height:120px;width:200px" src='https://managethenow.net/mtn-live/view/imgs/logos/CTRL-Medicine-Anatomical-Part.png' >
    ...
    width: 100%;' class="login100-form-title p-b-34 ">
							Add CTRL Medicine – Anatomical Part 
					</span>
