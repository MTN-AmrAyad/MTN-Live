...
<html lang="en">
<head>
	<title> CTRL Medicine-Organic </title>
	<meta charset="UTF-8">
...
<body style="background-image:url('https://managethenow.net/mtn-live/view/imgs/logos/CTRL-organic-part.png');background-size: cover; background-repeat: no-repeat;">
	<div class="limiter">
		<div class="container-login100">
		    
		       <img  src="adamandevep.png" style='opacity: 0.3; '>
    ...
    justify-content: center;'>
				        		<!--<img src='adamandeve.png' >-->
				        		 		<img  style="width:250px ;height:150px"src='https://managethenow.net/mtn-live/view/imgs/logos/CTRL-organic-part.png' >
				    </div>
		
					
				<h3 class="text-black mb-4 text-center" > CTRL Medicine – Organic
