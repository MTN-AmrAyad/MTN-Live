  ...
  const option = `
   <li class="option">
       <div class="flex items-center">
           ...
           <span class="country-name">${country.name} +${country.phone}</span>
       </div>
...
function selectOption() {
  ...
  // Here we put Phone Code under flag
...
//search_box.addEventListener("input", searchphone);
