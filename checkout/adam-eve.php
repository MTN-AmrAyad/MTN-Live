...
<body style='overflow-x: hidden;'>
    ...
    justify-content: center;'>
				        		<!--<img src='adamandeve.png' >-->
				        		 		<img  style="width:250px ;height:150px"src='https://managethenow.net/mtn-live/view/imgs/logos/Adam&Eve.png' >
				    </div>
		
					
				<h3 class="text-black mb-4 text-center" style="font-family:'Cairo' !important" >آدم وحواء -
				<span style='font-size: 15px;font-family:Cairo !important'>المستوى الأساسي</span>
 </h3>
...
<!--</select>-->
    				...
    				<div class="wrap-input100 " >
    				    <!--<input hidden value="0" name="birthdate" />-->
                    <div
                        class="relative mb-3"
