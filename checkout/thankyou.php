...
<body>
  ...
  stroke-dashoffset: 2000;  */
    ...
    <!-- <svg version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	 viewBox="0 0 850.89 425.664" style="enable-background:new 0 0 850.89 425.664;" xml:space="preserve">
<g> -->
<div style="border:1px solid #dedede;width:400px;text-align:center;margin: 0 auto;border-radius:8px;margin-top:20px" >
<h2 style ="text-align:center;margin-top:20px">An Activation Email will be Sent within 48 hours</h2>
</div>
    ...
    <svg id="Logo" class="Animate-Path" width="100%" height="100%" viewBox="0 0 900 792" xml:space="preserve">
...
$conn = mysqli_connect($sname, $unmae, $passwordd, $db_name);
  ...
  $wp = new WhatsappAPI("4474", "f2998eb29fb230a61e1a0060e846cc7ec6e430d0"); // create an object of the WhatsappAPI class with your user id and api key

  $number = '+'.$phone; // NOTE: Phone Number should be with country code
  $message = '
Dear '.$row['name'].', 
Thank you for signing up with '.$course_names[$_POST[$X]].' 
We wish to remind you that your account details (User name & Password) has been sent to your ('.$row['email'].')
...
نود أن نذكرك بأنه تم إرسال تفاصيل حسابك (اسم المستخدم وكلمة المرور) إلى عنوان ('.$row['email'].')
...
https://youtu.be/km3vgpkZOW4  
  ...
  '  ; // You can use WhatsApp Code to compose text messages like *bold*, ~Strikethrough~, ```Monospace```
